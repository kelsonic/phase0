...
// The delete terah.eyeColor problem was a bit difficult as originally I had just set it equal to null. 
// When that did not work, I decided to look up the proper keyword to delete an object property.

// How difficult was it to add and delete properties outside of the object itself?

// To add and delete properties, it's fairly easy. However, I had a bit of trouble figuring out how to delete 
// a property, but I ended up figuring out how to do it.

// What did you learn about manipulating objects in this challenge?

// It's rather easy, though it can get confusing if two objects have the same property and you 
// need to manipulate them both. It's a good idea to leave comments to explain the logic for 
// other developers.
